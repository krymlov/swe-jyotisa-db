...
REPLACE INTO `dignity` (`id`, `fid`, `code`, `name`) VALUES
	(0, 0, 'NIL', 'NIL'),
	(1, 1, 'DG1', 'NEECHA'),
	(2, 2, 'DG2', 'DEFICIENT'),
	(3, 3, 'DG3', 'ADHISATRU'),
...
REPLACE INTO `entity` (`id`, `enabled`, `updated`, `name`, `code`, `text`) VALUES
	(1, 0, 20211215093000, 'Kundali: London 0-2021 years', NULL, NULL),
	(2, 1, 20230628173000, 'Kundali: Kyiv 0-2051 years', NULL, NULL);
...
REPLACE INTO `event` (`id`, `entity_id`, `location_id`, `config_id`, `enabled`, `updated`, `name`, `code`, `text`) VALUES
	(1, 1, 1, 58, 0, 20211215093000, 'Kundali: London 0-2021 years', 'LONDON', 'TRUE_CITRA'),
	(2, 2, 2, 27, 1, 20230628173000, 'Kundali: Kyiv 0-2051 years', 'KYIV', 'TRUE_CITRA');
...
-- Дамп структуры для таблица jyotisa.house_system
DROP TABLE IF EXISTS `house_system`;
CREATE TABLE IF NOT EXISTS `house_system` (
  `id` tinyint NOT NULL DEFAULT '0',
  `fid` tinyint NOT NULL DEFAULT '0',
  `code` varchar(3) NOT NULL DEFAULT '',
  `name` varchar(16) NOT NULL DEFAULT '',
...
-- Дамп данных таблицы jyotisa.house_system: ~15 rows (приблизительно)
REPLACE INTO `house_system` (`id`, `fid`, `code`, `name`) VALUES
	(0, 0, 'NIL', 'NIL'),
	(1, 66, 'HSB', 'ALCABITIUS'),
	(2, 67, 'HSC', 'CAMPANUS'),
	(3, 69, 'HSE', 'EQUAL'),
...
REPLACE INTO `location` (`id`, `tmz_info_id`, `latitude`, `longitude`, `altitude`, `pressure`, `temperature`, `since_dt`, `country`, `name`, `area`) VALUES
	...
	(2, 2, 50270000, 30312400, 180, 1013.25, 11, 20230628173000, 'UA', 'Kyiv', 'Ukraine');
...
-- Дамп структуры для таблица jyotisa.vimsottari_dasa
DROP TABLE IF EXISTS `vimsottari_dasa`;
CREATE TABLE IF NOT EXISTS `vimsottari_dasa` (
  `id` tinyint NOT NULL DEFAULT '0',
  `fid` tinyint NOT NULL DEFAULT '0',
  `code` varchar(4) NOT NULL DEFAULT '',
  `name` varchar(16) NOT NULL DEFAULT '',
...
-- Дамп данных таблицы jyotisa.vimsottari_dasa: ~10 rows (приблизительно)
REPLACE INTO `vimsottari_dasa` (`id`, `fid`, `code`, `name`) VALUES
	(0, 0, 'NIL', 'NIL'),
	(1, 1, 'SYVD', 'SURYA_DASA'),
...
REPLACE INTO `_dbinfo` (`id`, `updated`, `version`, `revision`, `name`) VALUES
	...
	(3, 20230628173000, 23, 0, 'Jyotisa DB v23');

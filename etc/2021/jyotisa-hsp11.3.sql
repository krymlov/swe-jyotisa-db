...
-- Дамп структуры для таблица jyotisa.ayanamsa
DROP TABLE IF EXISTS `ayanamsa`;
CREATE TABLE IF NOT EXISTS `ayanamsa` (
...
-- Дамп данных таблицы jyotisa.ayanamsa: ~31 rows (приблизительно)
/*!40000 ALTER TABLE `ayanamsa` DISABLE KEYS */;
REPLACE INTO `ayanamsa` (`id`, `fid`, `code`, `name`) VALUES
	...
	(30, 255, 'AYUR', 'AY_USER');
/*!40000 ALTER TABLE `ayanamsa` ENABLE KEYS */;

-- Дамп структуры для таблица jyotisa.bhava
DROP TABLE IF EXISTS `bhava`;
CREATE TABLE IF NOT EXISTS `bhava` (
  `id` tinyint NOT NULL DEFAULT '0',
...
-- Дамп данных таблицы jyotisa.bhava: ~13 rows (приблизительно)
/*!40000 ALTER TABLE `bhava` DISABLE KEYS */;
REPLACE INTO `bhava` (`id`, `fid`, `trikona`, `kendra`, `apoklima`, `upachaya`, `apachaya`, `dusthana`, `panapara`, `chaturasra`, `maraka`, `trishadaya`, `code`, `name`) VALUES
...
/*!40000 ALTER TABLE `bhava` ENABLE KEYS */;

-- Дамп структуры для таблица jyotisa.chara_karaka
DROP TABLE IF EXISTS `chara_karaka`;
CREATE TABLE IF NOT EXISTS `chara_karaka` (
  `id` tinyint NOT NULL DEFAULT '0',
  `fid` tinyint NOT NULL DEFAULT '0',
  `code` varchar(3) NOT NULL DEFAULT '',
...
-- Дамп данных таблицы jyotisa.chara_karaka: ~9 rows (приблизительно)
/*!40000 ALTER TABLE `chara_karaka` DISABLE KEYS */;
REPLACE INTO `chara_karaka` (`id`, `fid`, `code`, `name`) VALUES
	(0, 0, 'NIL', 'NIL'),
	(1, 1, 'AK', 'ATMA_KARAKA'),
	...
	(7, 7, 'GK', 'GNATI_KARAKA'),
	(8, 8, 'DK', 'DARA_KARAKA');
/*!40000 ALTER TABLE `chara_karaka` ENABLE KEYS */;

-- Дамп структуры для таблица jyotisa.config
...
-- Дамп данных таблицы jyotisa.config: ~62 rows (приблизительно)
/*!40000 ALTER TABLE `config` DISABLE KEYS */;
REPLACE INTO `config` (`id`, `enabled`, `ayanamsa`, `chara_karaka`, `year_duration`, `name`) VALUES
	(0, 1, 0, 7, 365.2425, 'FAGAN_BRADLEY'),
	(1, 1, 1, 7, 365.2425, 'LAHIRI'),
	(2, 1, 2, 7, 365.2425, 'DELUCE'),
	(3, 1, 3, 7, 365.2425, 'BV_RAMAN'),
	(4, 1, 4, 7, 365.2425, 'USHA_SHASHI'),
	(5, 1, 5, 7, 365.2425, 'KRISHNAMURTI'),
	(6, 1, 6, 7, 365.2425, 'DJWHAL_KHOOL'),
	(7, 1, 7, 7, 365.2425, 'SHRI_YUKTESHWAR'),
	(8, 1, 8, 7, 365.2425, 'JN_BHASIN'),
	(9, 1, 9, 7, 365.2425, 'BABYL_KUGLER1'),
	(10, 1, 10, 7, 365.2425, 'BABYL_KUGLER2'),
	(11, 1, 11, 7, 365.2425, 'BABYL_KUGLER3'),
	(12, 1, 12, 7, 365.2425, 'BABYL_HUBER'),
	(13, 1, 13, 7, 365.2425, 'BABYL_MERCIER'),
	(14, 1, 14, 7, 365.2425, 'ALDEBARAN_15TAU'),
	(15, 1, 15, 7, 365.2425, 'HIPPARCHOS'),
	(16, 1, 16, 7, 365.2425, 'SASSANIAN'),
	(17, 1, 17, 7, 365.2425, 'GALCENT_0SAG'),
	(18, 1, 18, 7, 365.2425, 'J2000'),
	(19, 1, 19, 7, 365.2425, 'J1900'),
	(20, 1, 20, 7, 365.2425, 'B1950'),
	(21, 1, 21, 7, 365.2425, 'SURYA_SIDDHANTA'),
	(22, 1, 22, 7, 365.2425, 'SURYA_SIDDHANTA_MSUN'),
	(23, 1, 23, 7, 365.2425, 'ARYABHATA'),
	(24, 1, 24, 7, 365.2425, 'ARYABHATA_MSUN'),
	(25, 1, 25, 7, 365.2425, 'SS_REVATI'),
	(26, 1, 26, 7, 365.2425, 'SS_CITRA'),
	(27, 1, 27, 7, 365.2425, 'TRUE_CITRA'),
	(28, 1, 28, 7, 365.2425, 'TRUE_REVATI'),
	(29, 1, 29, 7, 365.2425, 'TRUE_PUSHYA'),
	(30, 1, 30, 7, 365.2425, 'AY_USER'),
	(31, 1, 0, 8, 365.2425, 'FAGAN_BRADLEY'),
	(32, 1, 1, 8, 365.2425, 'LAHIRI'),
	(33, 1, 2, 8, 365.2425, 'DELUCE'),
	(34, 1, 3, 8, 365.2425, 'BV_RAMAN'),
	(35, 1, 4, 8, 365.2425, 'USHA_SHASHI'),
	(36, 1, 5, 8, 365.2425, 'KRISHNAMURTI'),
	(37, 1, 6, 8, 365.2425, 'DJWHAL_KHOOL'),
	(38, 1, 7, 8, 365.2425, 'SHRI_YUKTESHWAR'),
	(39, 1, 8, 8, 365.2425, 'JN_BHASIN'),
	(40, 1, 9, 8, 365.2425, 'BABYL_KUGLER1'),
	(41, 1, 10, 8, 365.2425, 'BABYL_KUGLER2'),
	(42, 1, 11, 8, 365.2425, 'BABYL_KUGLER3'),
	(43, 1, 12, 8, 365.2425, 'BABYL_HUBER'),
	(44, 1, 13, 8, 365.2425, 'BABYL_MERCIER'),
	(45, 1, 14, 8, 365.2425, 'ALDEBARAN_15TAU'),
	(46, 1, 15, 8, 365.2425, 'HIPPARCHOS'),
	(47, 1, 16, 8, 365.2425, 'SASSANIAN'),
	(48, 1, 17, 8, 365.2425, 'GALCENT_0SAG'),
	(49, 1, 18, 8, 365.2425, 'J2000'),
	(50, 1, 19, 8, 365.2425, 'J1900'),
	(51, 1, 20, 8, 365.2425, 'B1950'),
	(52, 1, 21, 8, 365.2425, 'SURYA_SIDDHANTA'),
	(53, 1, 22, 8, 365.2425, 'SURYA_SIDDHANTA_MSUN'),
	(54, 1, 23, 8, 365.2425, 'ARYABHATA'),
	(55, 1, 24, 8, 365.2425, 'ARYABHATA_MSUN'),
	(56, 1, 25, 8, 365.2425, 'SS_REVATI'),
	(57, 1, 26, 8, 365.2425, 'SS_CITRA'),
	(58, 1, 27, 8, 365.2425, 'TRUE_CITRA'),
	(59, 1, 28, 8, 365.2425, 'TRUE_REVATI'),
	(60, 1, 29, 8, 365.2425, 'TRUE_PUSHYA'),
	(61, 1, 30, 8, 365.2425, 'AY_USER');
/*!40000 ALTER TABLE `config` ENABLE KEYS */;

-- Дамп структуры для таблица jyotisa.d1_bbindu
DROP TABLE IF EXISTS `d1_bbindu`;
CREATE TABLE IF NOT EXISTS `d1_bbindu` (
...
-- Дамп данных таблицы jyotisa.d1_bbindu: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `d1_bbindu` DISABLE KEYS */;
/*!40000 ALTER TABLE `d1_bbindu` ENABLE KEYS */;

-- Дамп структуры для таблица jyotisa.d1_graha1
DROP TABLE IF EXISTS `d1_graha1`;
CREATE TABLE IF NOT EXISTS `d1_graha1` (
  `kundali_id` int NOT NULL DEFAULT '0',
...
-- Дамп данных таблицы jyotisa.d1_graha1: ~365 rows (приблизительно)
/*!40000 ALTER TABLE `d1_graha1` DISABLE KEYS */;
/*!40000 ALTER TABLE `d1_graha1` ENABLE KEYS */;

-- Дамп структуры для таблица jyotisa.d1_graha10
DROP TABLE IF EXISTS `d1_graha10`;
CREATE TABLE IF NOT EXISTS `d1_graha10` (
  `kundali_id` int NOT NULL DEFAULT '0',
  `chara_karaka` tinyint NOT NULL DEFAULT '0',
  `mrityu_bhaga` tinyint NOT NULL DEFAULT '0',
  `dignity` tinyint NOT NULL DEFAULT '0',
...
-- Дамп данных таблицы jyotisa.d1_graha10: ~365 rows (приблизительно)
/*!40000 ALTER TABLE `d1_graha10` DISABLE KEYS */;
/*!40000 ALTER TABLE `d1_graha10` ENABLE KEYS */;

-- Дамп структуры для таблица jyotisa.d1_graha11
DROP TABLE IF EXISTS `d1_graha11`;
CREATE TABLE IF NOT EXISTS `d1_graha11` (
  `kundali_id` int NOT NULL DEFAULT '0',
  `chara_karaka` tinyint NOT NULL DEFAULT '0',
  `mrityu_bhaga` tinyint NOT NULL DEFAULT '0',
  `dignity` tinyint NOT NULL DEFAULT '0',
...
-- Дамп данных таблицы jyotisa.d1_graha11: ~365 rows (приблизительно)
/*!40000 ALTER TABLE `d1_graha11` DISABLE KEYS */;
/*!40000 ALTER TABLE `d1_graha11` ENABLE KEYS */;

-- Дамп структуры для таблица jyotisa.d1_graha12
DROP TABLE IF EXISTS `d1_graha12`;
CREATE TABLE IF NOT EXISTS `d1_graha12` (
  `kundali_id` int NOT NULL DEFAULT '0',
  `chara_karaka` tinyint NOT NULL DEFAULT '0',
  `mrityu_bhaga` tinyint NOT NULL DEFAULT '0',
  `dignity` tinyint NOT NULL DEFAULT '0',
...
-- Дамп данных таблицы jyotisa.d1_graha12: ~365 rows (приблизительно)
/*!40000 ALTER TABLE `d1_graha12` DISABLE KEYS */;
/*!40000 ALTER TABLE `d1_graha12` ENABLE KEYS */;

-- Дамп структуры для таблица jyotisa.d1_graha2
DROP TABLE IF EXISTS `d1_graha2`;
CREATE TABLE IF NOT EXISTS `d1_graha2` (
  `kundali_id` int NOT NULL DEFAULT '0',
  `chara_karaka` tinyint NOT NULL DEFAULT '0',
  `mrityu_bhaga` tinyint NOT NULL DEFAULT '0',
  `dignity` tinyint NOT NULL DEFAULT '0',
...
-- Дамп данных таблицы jyotisa.d1_graha2: ~365 rows (приблизительно)
/*!40000 ALTER TABLE `d1_graha2` DISABLE KEYS */;
/*!40000 ALTER TABLE `d1_graha2` ENABLE KEYS */;

-- Дамп структуры для таблица jyotisa.d1_graha3
DROP TABLE IF EXISTS `d1_graha3`;
CREATE TABLE IF NOT EXISTS `d1_graha3` (
  `kundali_id` int NOT NULL DEFAULT '0',
  `chara_karaka` tinyint NOT NULL DEFAULT '0',
  `mrityu_bhaga` tinyint NOT NULL DEFAULT '0',
  `dignity` tinyint NOT NULL DEFAULT '0',
...
-- Дамп данных таблицы jyotisa.d1_graha3: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `d1_graha3` DISABLE KEYS */;
/*!40000 ALTER TABLE `d1_graha3` ENABLE KEYS */;

-- Дамп структуры для таблица jyotisa.d1_graha4
DROP TABLE IF EXISTS `d1_graha4`;
CREATE TABLE IF NOT EXISTS `d1_graha4` (
  `kundali_id` int NOT NULL DEFAULT '0',
  `chara_karaka` tinyint NOT NULL DEFAULT '0',
  `mrityu_bhaga` tinyint NOT NULL DEFAULT '0',
  `dignity` tinyint NOT NULL DEFAULT '0',
...
-- Дамп данных таблицы jyotisa.d1_graha4: ~365 rows (приблизительно)
/*!40000 ALTER TABLE `d1_graha4` DISABLE KEYS */;
/*!40000 ALTER TABLE `d1_graha4` ENABLE KEYS */;

-- Дамп структуры для таблица jyotisa.d1_graha5
DROP TABLE IF EXISTS `d1_graha5`;
CREATE TABLE IF NOT EXISTS `d1_graha5` (
  `kundali_id` int NOT NULL DEFAULT '0',
  `chara_karaka` tinyint NOT NULL DEFAULT '0',
  `mrityu_bhaga` tinyint NOT NULL DEFAULT '0',
  `dignity` tinyint NOT NULL DEFAULT '0',
...
-- Дамп данных таблицы jyotisa.d1_graha5: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `d1_graha5` DISABLE KEYS */;
/*!40000 ALTER TABLE `d1_graha5` ENABLE KEYS */;

-- Дамп структуры для таблица jyotisa.d1_graha6
DROP TABLE IF EXISTS `d1_graha6`;
CREATE TABLE IF NOT EXISTS `d1_graha6` (
  `kundali_id` int NOT NULL DEFAULT '0',
  `chara_karaka` tinyint NOT NULL DEFAULT '0',
  `mrityu_bhaga` tinyint NOT NULL DEFAULT '0',
  `dignity` tinyint NOT NULL DEFAULT '0',
...
-- Дамп данных таблицы jyotisa.d1_graha6: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `d1_graha6` DISABLE KEYS */;
/*!40000 ALTER TABLE `d1_graha6` ENABLE KEYS */;

-- Дамп структуры для таблица jyotisa.d1_graha7
DROP TABLE IF EXISTS `d1_graha7`;
CREATE TABLE IF NOT EXISTS `d1_graha7` (
  `kundali_id` int NOT NULL DEFAULT '0',
  `chara_karaka` tinyint NOT NULL DEFAULT '0',
  `mrityu_bhaga` tinyint NOT NULL DEFAULT '0',
  `dignity` tinyint NOT NULL DEFAULT '0',
...
-- Дамп данных таблицы jyotisa.d1_graha7: ~365 rows (приблизительно)
/*!40000 ALTER TABLE `d1_graha7` DISABLE KEYS */;
/*!40000 ALTER TABLE `d1_graha7` ENABLE KEYS */;

-- Дамп структуры для таблица jyotisa.d1_graha8
DROP TABLE IF EXISTS `d1_graha8`;
CREATE TABLE IF NOT EXISTS `d1_graha8` (
  `kundali_id` int NOT NULL DEFAULT '0',
  `chara_karaka` tinyint NOT NULL DEFAULT '0',
  `mrityu_bhaga` tinyint NOT NULL DEFAULT '0',
  `dignity` tinyint NOT NULL DEFAULT '0',
...
-- Дамп данных таблицы jyotisa.d1_graha8: ~365 rows (приблизительно)
/*!40000 ALTER TABLE `d1_graha8` DISABLE KEYS */;
/*!40000 ALTER TABLE `d1_graha8` ENABLE KEYS */;

-- Дамп структуры для таблица jyotisa.d1_graha9
DROP TABLE IF EXISTS `d1_graha9`;
CREATE TABLE IF NOT EXISTS `d1_graha9` (
  `kundali_id` int NOT NULL DEFAULT '0',
  `chara_karaka` tinyint NOT NULL DEFAULT '0',
  `mrityu_bhaga` tinyint NOT NULL DEFAULT '0',
  `dignity` tinyint NOT NULL DEFAULT '0',
...
-- Дамп данных таблицы jyotisa.d1_graha9: ~365 rows (приблизительно)
/*!40000 ALTER TABLE `d1_graha9` DISABLE KEYS */;
/*!40000 ALTER TABLE `d1_graha9` ENABLE KEYS */;

-- Дамп структуры для таблица jyotisa.d1_lagna0
DROP TABLE IF EXISTS `d1_lagna0`;
CREATE TABLE IF NOT EXISTS `d1_lagna0` (
  `kundali_id` int NOT NULL DEFAULT '0',
...
-- Дамп данных таблицы jyotisa.d1_lagna0: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `d1_lagna0` DISABLE KEYS */;
/*!40000 ALTER TABLE `d1_lagna0` ENABLE KEYS */;

-- Дамп структуры для таблица jyotisa.d1_lagna1
DROP TABLE IF EXISTS `d1_lagna1`;
CREATE TABLE IF NOT EXISTS `d1_lagna1` (
  `kundali_id` int NOT NULL DEFAULT '0',
  `bhava` tinyint NOT NULL DEFAULT '1',
  `rasi` tinyint NOT NULL DEFAULT '0',
  `rasi_rate` tinyint NOT NULL DEFAULT '0',
...
-- Дамп данных таблицы jyotisa.d1_lagna1: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `d1_lagna1` DISABLE KEYS */;
/*!40000 ALTER TABLE `d1_lagna1` ENABLE KEYS */;

-- Дамп структуры для таблица jyotisa.d1_lagna2
DROP TABLE IF EXISTS `d1_lagna2`;
CREATE TABLE IF NOT EXISTS `d1_lagna2` (
  `kundali_id` int NOT NULL DEFAULT '0',
  `bhava` tinyint NOT NULL DEFAULT '1',
  `rasi` tinyint NOT NULL DEFAULT '0',
  `rasi_rate` tinyint NOT NULL DEFAULT '0',
...
-- Дамп данных таблицы jyotisa.d1_lagna2: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `d1_lagna2` DISABLE KEYS */;
/*!40000 ALTER TABLE `d1_lagna2` ENABLE KEYS */;

-- Дамп структуры для таблица jyotisa.d1_lagna3
DROP TABLE IF EXISTS `d1_lagna3`;
CREATE TABLE IF NOT EXISTS `d1_lagna3` (
  `kundali_id` int NOT NULL DEFAULT '0',
  `bhava` tinyint NOT NULL DEFAULT '1',
  `rasi` tinyint NOT NULL DEFAULT '0',
  `rasi_rate` tinyint NOT NULL DEFAULT '0',
...
-- Дамп данных таблицы jyotisa.d1_lagna3: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `d1_lagna3` DISABLE KEYS */;
/*!40000 ALTER TABLE `d1_lagna3` ENABLE KEYS */;

-- Дамп структуры для таблица jyotisa.d1_upagraha1
DROP TABLE IF EXISTS `d1_upagraha1`;
CREATE TABLE IF NOT EXISTS `d1_upagraha1` (
  `kundali_id` int NOT NULL DEFAULT '0',
  `bhava` tinyint NOT NULL DEFAULT '0',
  `rasi` tinyint NOT NULL DEFAULT '0',
  `rasi_rate` tinyint NOT NULL DEFAULT '0',
...
-- Дамп данных таблицы jyotisa.d1_upagraha1: ~365 rows (приблизительно)
/*!40000 ALTER TABLE `d1_upagraha1` DISABLE KEYS */;
/*!40000 ALTER TABLE `d1_upagraha1` ENABLE KEYS */;

-- Дамп структуры для таблица jyotisa.d1_upagraha2
DROP TABLE IF EXISTS `d1_upagraha2`;
CREATE TABLE IF NOT EXISTS `d1_upagraha2` (
  `kundali_id` int NOT NULL DEFAULT '0',
  `bhava` tinyint NOT NULL DEFAULT '0',
  `rasi` tinyint NOT NULL DEFAULT '0',
  `rasi_rate` tinyint NOT NULL DEFAULT '0',
...
-- Дамп данных таблицы jyotisa.d1_upagraha2: ~365 rows (приблизительно)
/*!40000 ALTER TABLE `d1_upagraha2` DISABLE KEYS */;
/*!40000 ALTER TABLE `d1_upagraha2` ENABLE KEYS */;

-- Дамп структуры для таблица jyotisa.d1_upagraha3
DROP TABLE IF EXISTS `d1_upagraha3`;
CREATE TABLE IF NOT EXISTS `d1_upagraha3` (
  `kundali_id` int NOT NULL DEFAULT '0',
  `bhava` tinyint NOT NULL DEFAULT '0',
  `rasi` tinyint NOT NULL DEFAULT '0',
  `rasi_rate` tinyint NOT NULL DEFAULT '0',
...
-- Дамп данных таблицы jyotisa.d1_upagraha3: ~365 rows (приблизительно)
/*!40000 ALTER TABLE `d1_upagraha3` DISABLE KEYS */;
/*!40000 ALTER TABLE `d1_upagraha3` ENABLE KEYS */;

-- Дамп структуры для таблица jyotisa.d1_upagraha4
DROP TABLE IF EXISTS `d1_upagraha4`;
CREATE TABLE IF NOT EXISTS `d1_upagraha4` (
  `kundali_id` int NOT NULL DEFAULT '0',
  `bhava` tinyint NOT NULL DEFAULT '0',
  `rasi` tinyint NOT NULL DEFAULT '0',
  `rasi_rate` tinyint NOT NULL DEFAULT '0',
...
-- Дамп данных таблицы jyotisa.d1_upagraha4: ~365 rows (приблизительно)
/*!40000 ALTER TABLE `d1_upagraha4` DISABLE KEYS */;
/*!40000 ALTER TABLE `d1_upagraha4` ENABLE KEYS */;

-- Дамп структуры для таблица jyotisa.d1_upagraha5
DROP TABLE IF EXISTS `d1_upagraha5`;
CREATE TABLE IF NOT EXISTS `d1_upagraha5` (
  `kundali_id` int NOT NULL DEFAULT '0',
  `bhava` tinyint NOT NULL DEFAULT '0',
  `rasi` tinyint NOT NULL DEFAULT '0',
  `rasi_rate` tinyint NOT NULL DEFAULT '0',
...
-- Дамп данных таблицы jyotisa.d1_upagraha5: ~365 rows (приблизительно)
/*!40000 ALTER TABLE `d1_upagraha5` DISABLE KEYS */;
/*!40000 ALTER TABLE `d1_upagraha5` ENABLE KEYS */;

-- Дамп структуры для таблица jyotisa.dignity
DROP TABLE IF EXISTS `dignity`;
CREATE TABLE IF NOT EXISTS `dignity` (
  `id` tinyint NOT NULL DEFAULT '0',
  `fid` tinyint NOT NULL DEFAULT '0',
...
-- Дамп данных таблицы jyotisa.dignity: ~12 rows (приблизительно)
/*!40000 ALTER TABLE `dignity` DISABLE KEYS */;
REPLACE INTO `dignity` (`id`, `fid`, `power`, `code`, `name`) VALUES
	(0, 0, 0, 'NIL', 'NIL'),
	(1, 1, 0, 'DG1', 'NEECHA'),
	(2, 2, 1, 'DG2', 'DEFICIENT'),
	(3, 3, 3, 'DG3', 'ADHISATRU'),
	...
	(5, 5, 12, 'DG5', 'SAMA'),
	(6, 6, 25, 'DG6', 'MITRA'),
	(7, 7, 37, 'DG7', 'ADHIMITRA'),
	(8, 8, 50, 'DG8', 'SWAKSHETRA'),
	(9, 9, 75, 'DG9', 'MULATRIKONA'),
	(10, 10, 95, 'DG10', 'EXCELLENT'),
	(11, 11, 100, 'DG11', 'UCCHA');
/*!40000 ALTER TABLE `dignity` ENABLE KEYS */;
...
-- Дамп данных таблицы jyotisa.entity: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `entity` DISABLE KEYS */;
REPLACE INTO `entity` (`id`, `enabled`, `updated`, `name`, `code`, `text`) VALUES
	(1, 1, 20211215093000, 'Kundali: London 0-2021 years', NULL, NULL);
...
-- Дамп данных таблицы jyotisa.event: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `event` DISABLE KEYS */;
REPLACE INTO `event` (`id`, `entity_id`, `location_id`, `config_id`, `enabled`, `updated`, `name`, `code`, `text`) VALUES
	(1, 1, 1, 58, 1, 20211215093000, 'Kundali: London 0-2021 years', NULL, 'TRUE_CITRA');
/*!40000 ALTER TABLE `event` ENABLE KEYS */;

-- Дамп структуры для таблица jyotisa.gender
...
-- Дамп данных таблицы jyotisa.gender: ~2 rows (приблизительно)
/*!40000 ALTER TABLE `gender` DISABLE KEYS */;
REPLACE INTO `gender` (`id`, `fid`, `code`, `name`) VALUES
	(0, 0, '0', 'FEMALE'),
	(1, 1, '1', 'MALE');
/*!40000 ALTER TABLE `gender` ENABLE KEYS */;

-- Дамп структуры для таблица jyotisa.graha
DROP TABLE IF EXISTS `graha`;
CREATE TABLE IF NOT EXISTS `graha` (
  `id` tinyint NOT NULL DEFAULT '0',
  `fid` tinyint NOT NULL DEFAULT '0',
...
-- Дамп данных таблицы jyotisa.graha: ~13 rows (приблизительно)
/*!40000 ALTER TABLE `graha` DISABLE KEYS */;
REPLACE INTO `graha` (`id`, `fid`, `code`, `name`) VALUES
	(0, 0, 'LG', 'LAGNA'),
	(1, 1, 'SY', 'SURYA'),
	(2, 2, 'CH', 'CHANDRA'),
	(3, 9, 'MA', 'MANGALA'),
	...
	(11, 11, 'SM', 'SYAMA'),
	(12, 12, 'TE', 'TEEVRA');
/*!40000 ALTER TABLE `graha` ENABLE KEYS */;

-- Дамп структуры для таблица jyotisa.housesys
DROP TABLE IF EXISTS `housesys`;
CREATE TABLE IF NOT EXISTS `housesys` (
  `id` tinyint NOT NULL DEFAULT '0',
  `fid` tinyint NOT NULL DEFAULT '0',
  `code` varchar(3) NOT NULL DEFAULT '',
  `name` varchar(16) NOT NULL DEFAULT '',
...
-- Дамп данных таблицы jyotisa.housesys: ~15 rows (приблизительно)
/*!40000 ALTER TABLE `housesys` DISABLE KEYS */;
REPLACE INTO `housesys` (`id`, `fid`, `code`, `name`) VALUES
	(0, 0, 'NIL', 'NIL'),
	(1, 66, 'HSB', 'ALCABITIUS'),
	(2, 67, 'HSC', 'CAMPANUS'),
	(3, 69, 'HSE', 'EQUAL'),
	...
	(14, 88, 'HSX', 'MERIDIAN');
/*!40000 ALTER TABLE `housesys` ENABLE KEYS */;

-- Дамп структуры для таблица jyotisa.karana
...
-- Дамп данных таблицы jyotisa.karana: ~12 rows (приблизительно)
/*!40000 ALTER TABLE `karana` DISABLE KEYS */;
REPLACE INTO `karana` (`id`, `fid`, `code`, `name`) VALUES
	(0, 0, 'NIL', 'NIL'),
	(1, 1, 'KR1', 'BAVA'),
	(2, 2, 'KR2', 'BALAVA'),
	(3, 3, 'KR3', 'KAULAVA'),
...
/*!40000 ALTER TABLE `karana` ENABLE KEYS */;
...
-- Дамп данных таблицы jyotisa.kundali: ~365 rows (приблизительно)
/*!40000 ALTER TABLE `kundali` DISABLE KEYS */;
/*!40000 ALTER TABLE `kundali` ENABLE KEYS */;

-- Дамп структуры для таблица jyotisa.lagna
...
-- Дамп данных таблицы jyotisa.lagna: ~9 rows (приблизительно)
/*!40000 ALTER TABLE `lagna` DISABLE KEYS */;
REPLACE INTO `lagna` (`id`, `fid`, `code`, `name`) VALUES
	(0, 0, 'L0', 'JANMA_LAGNA'),
	(1, 1, 'L1', 'BHAVA_LAGNA'),
	(2, 2, 'L2', 'HORA_LAGNA'),
	(3, 3, 'L3', 'GHATI_LAGNA'),
	...
	(8, 8, 'L8', 'INDU_LAGNA');
/*!40000 ALTER TABLE `lagna` ENABLE KEYS */;

-- Дамп структуры для таблица jyotisa.location
...
-- Дамп данных таблицы jyotisa.location: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `location` DISABLE KEYS */;
REPLACE INTO `location` (`id`, `tmz_info_id`, `latitude`, `longitude`, `altitude`, `pressure`, `temperature`, `since_dt`, `country`, `name`, `area`) VALUES
	(1, 1, 51300000, -70000, 11, 1013.25, 8, 20211215130000, 'UK', 'London', 'United Kingdom');
/*!40000 ALTER TABLE `location` ENABLE KEYS */;

-- Дамп структуры для таблица jyotisa.maasa
DROP TABLE IF EXISTS `maasa`;
CREATE TABLE IF NOT EXISTS `maasa` (
  `id` tinyint NOT NULL DEFAULT '0',
  `fid` tinyint NOT NULL DEFAULT '0',
  `code` varchar(4) NOT NULL DEFAULT '',
  `name` varchar(12) NOT NULL DEFAULT '',
...
-- Дамп данных таблицы jyotisa.maasa: ~14 rows (приблизительно)
/*!40000 ALTER TABLE `maasa` DISABLE KEYS */;
REPLACE INTO `maasa` (`id`, `fid`, `code`, `name`) VALUES
	(0, 0, 'NIL', 'NIL'),
	(1, 1, 'MA1', 'MADHUSUDANA'),
	(2, 2, 'MA2', 'TRIVIKRAMA'),
	(3, 3, 'MA3', 'VAMANA'),
	...
	(12, 12, 'MA12', 'VISNU'),
	(13, 13, 'MA13', 'PURADH');
/*!40000 ALTER TABLE `maasa` ENABLE KEYS */;

-- Дамп структуры для таблица jyotisa.moment
...
-- Дамп данных таблицы jyotisa.moment: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `moment` DISABLE KEYS */;
/*!40000 ALTER TABLE `moment` ENABLE KEYS */;

-- Дамп структуры для таблица jyotisa.naksatra
DROP TABLE IF EXISTS `naksatra`;
CREATE TABLE IF NOT EXISTS `naksatra` (
  `id` tinyint NOT NULL DEFAULT '0',
  `fid` tinyint NOT NULL DEFAULT '0',
...
-- Дамп данных таблицы jyotisa.naksatra: ~28 rows (приблизительно)
/*!40000 ALTER TABLE `naksatra` DISABLE KEYS */;
REPLACE INTO `naksatra` (`id`, `fid`, `lord`, `start`, `close`, `code`, `name`) VALUES
	(0, 0, 0, 0, 0, 'NIL', 'NIL'),
...
/*!40000 ALTER TABLE `naksatra` ENABLE KEYS */;

-- Дамп структуры для таблица jyotisa.naksatra_pada
DROP TABLE IF EXISTS `naksatra_pada`;
CREATE TABLE IF NOT EXISTS `naksatra_pada` (
  `id` tinyint NOT NULL DEFAULT '0',
  `fid` smallint NOT NULL DEFAULT '0',
  `naksatra` tinyint NOT NULL DEFAULT '0',
...
-- Дамп данных таблицы jyotisa.naksatra_pada: ~109 rows (приблизительно)
/*!40000 ALTER TABLE `naksatra_pada` DISABLE KEYS */;
REPLACE INTO `naksatra_pada` (`id`, `fid`, `naksatra`, `pada`, `rasi`, `navamsa`, `start`, `close`, `code`, `name`) VALUES
...
/*!40000 ALTER TABLE `naksatra_pada` ENABLE KEYS */;

-- Дамп структуры для таблица jyotisa.nitya_yoga
DROP TABLE IF EXISTS `nitya_yoga`;
CREATE TABLE IF NOT EXISTS `nitya_yoga` (
  `id` tinyint NOT NULL DEFAULT '0',
  `fid` tinyint NOT NULL DEFAULT '0',
  `code` varchar(4) NOT NULL DEFAULT '',
  `name` varchar(32) NOT NULL DEFAULT '',
...
-- Дамп данных таблицы jyotisa.nitya_yoga: ~28 rows (приблизительно)
/*!40000 ALTER TABLE `nitya_yoga` DISABLE KEYS */;
REPLACE INTO `nitya_yoga` (`id`, `fid`, `code`, `name`) VALUES
	(0, 0, 'NIL', 'NIL'),
	(1, 1, 'NY1', 'VISHKAMBHA'),
	(2, 2, 'NY2', 'PREETI'),
	(3, 3, 'NY3', 'AYUSHMANA'),
...
/*!40000 ALTER TABLE `nitya_yoga` ENABLE KEYS */;

-- Дамп структуры для таблица jyotisa.panchanga
...
-- Дамп данных таблицы jyotisa.panchanga: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `panchanga` DISABLE KEYS */;
/*!40000 ALTER TABLE `panchanga` ENABLE KEYS */;

-- Дамп структуры для таблица jyotisa.rasi
...
-- Дамп данных таблицы jyotisa.rasi: ~13 rows (приблизительно)
/*!40000 ALTER TABLE `rasi` DISABLE KEYS */;
REPLACE INTO `rasi` (`id`, `fid`, `movable`, `fixed`, `dual`, `tattva`, `lord`, `start`, `close`, `code`, `name`) VALUES
...
/*!40000 ALTER TABLE `rasi` ENABLE KEYS */;

-- Дамп структуры для таблица jyotisa.tattva
DROP TABLE IF EXISTS `tattva`;
CREATE TABLE IF NOT EXISTS `tattva` (
  `id` tinyint NOT NULL DEFAULT '0',
  `fid` tinyint NOT NULL DEFAULT '0',
  `code` varchar(3) NOT NULL DEFAULT '',
  `name` varchar(8) NOT NULL DEFAULT '',
...
-- Дамп данных таблицы jyotisa.tattva: ~6 rows (приблизительно)
/*!40000 ALTER TABLE `tattva` DISABLE KEYS */;
REPLACE INTO `tattva` (`id`, `fid`, `code`, `name`) VALUES
	(0, 0, 'NIL', 'NIL'),
	(1, 1, 'TT1', 'AKASHA'),
	(2, 2, 'TT2', 'AGNI'),
	(3, 3, 'TT3', 'PRITHVI'),
	(4, 4, 'TT4', 'VAYU'),
	(5, 5, 'TT5', 'JALA');
/*!40000 ALTER TABLE `tattva` ENABLE KEYS */;

-- Дамп структуры для таблица jyotisa.tithi
...
-- Дамп данных таблицы jyotisa.tithi: ~31 rows (приблизительно)
/*!40000 ALTER TABLE `tithi` DISABLE KEYS */;
REPLACE INTO `tithi` (`id`, `fid`, `paksa`, `lord`, `start`, `close`, `code`, `name`) VALUES
	(0, 0, 0, 0, 0, 0, 'NIL', 'NIL'),
	(1, 1, 1, 1, 0, 12000000, 'S1', 'SHUKLA_PRATIPADA'),
	(2, 2, 1, 2, 12000000, 24000000, 'S2', 'SHUKLA_DWITIYA'),
	(3, 3, 1, 9, 24000000, 36000000, 'S3', 'SHUKLA_TRITIYA'),
	(4, 4, 1, 5, 36000000, 48000000, 'S4', 'SHUKLA_CHATURTHI'),
	(5, 5, 1, 3, 48000000, 60000000, 'S5', 'SHUKLA_PANCHAMI'),
	(6, 6, 1, 6, 60000000, 72000000, 'S6', 'SHUKLA_SHASHTHI'),
	(7, 7, 1, 8, 72000000, 84000000, 'S7', 'SHUKLA_SAPTAMI'),
	(8, 8, 1, 4, 84000000, 96000000, 'S8', 'SHUKLA_ASHTAMI'),
	(9, 9, 1, 1, 96000000, 108000000, 'S9', 'SHUKLA_NAVAMI'),
	(10, 10, 1, 2, 108000000, 120000000, 'S10', 'SHUKLA_DASHAMI'),
	(11, 11, 1, 9, 120000000, 132000000, 'S11', 'SHUKLA_EKADASI'),
	(12, 12, 1, 5, 132000000, 144000000, 'S12', 'SHUKLA_DWADASI'),
	(13, 13, 1, 3, 144000000, 156000000, 'S13', 'SHUKLA_TRAYODASI'),
	(14, 14, 1, 6, 156000000, 168000000, 'S14', 'SHUKLA_CHATURDASI'),
	(15, 15, 1, 8, 168000000, 180000000, 'S15', 'SHUKLA_POORNIMA'),
	(16, 1, 0, 1, 180000000, 192000000, 'K1', 'KRISHNA_PRATIPADA'),
	(17, 2, 0, 2, 192000000, 204000000, 'K2', 'KRISHNA_DWITIYA'),
	(18, 3, 0, 9, 204000000, 216000000, 'K3', 'KRISHNA_TRITIYA'),
	(19, 4, 0, 5, 216000000, 228000000, 'K4', 'KRISHNA_CHATURTHI'),
	(20, 5, 0, 3, 228000000, 240000000, 'K5', 'KRISHNA_PANCHAMI'),
	(21, 6, 0, 6, 240000000, 252000000, 'K6', 'KRISHNA_SHASHTHI'),
	(22, 7, 0, 8, 252000000, 264000000, 'K7', 'KRISHNA_SAPTAMI'),
	(23, 8, 0, 4, 264000000, 276000000, 'K8', 'KRISHNA_ASHTAMI'),
	(24, 9, 0, 1, 276000000, 288000000, 'K9', 'KRISHNA_NAVAMI'),
	(25, 10, 0, 2, 288000000, 300000000, 'K10', 'KRISHNA_DASHAMI'),
	(26, 11, 0, 9, 300000000, 312000000, 'K11', 'KRISHNA_EKADASI'),
	(27, 12, 0, 5, 312000000, 324000000, 'K12', 'KRISHNA_DWADASI'),
	(28, 13, 0, 3, 324000000, 336000000, 'K13', 'KRISHNA_TRAYODASI'),
	(29, 14, 0, 6, 336000000, 348000000, 'K14', 'KRISHNA_CHATURDASI'),
	(30, 15, 0, 4, 348000000, 360000000, 'K15', 'KRISHNA_AMAVASYA');
/*!40000 ALTER TABLE `tithi` ENABLE KEYS */;

-- Дамп структуры для таблица jyotisa.tmz_info
DROP TABLE IF EXISTS `tmz_info`;
CREATE TABLE IF NOT EXISTS `tmz_info` (
  `id` int NOT NULL AUTO_INCREMENT,
...
-- Дамп данных таблицы jyotisa.tmz_info: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `tmz_info` DISABLE KEYS */;
REPLACE INTO `tmz_info` (`id`, `raw_offset`, `dst_offset`, `time_zone_id`, `time_zone_name`) VALUES
	(1, 0, 3600, 'Europe/London', 'Europe London');
/*!40000 ALTER TABLE `tmz_info` ENABLE KEYS */;

-- Дамп структуры для таблица jyotisa.upagraha
DROP TABLE IF EXISTS `upagraha`;
CREATE TABLE IF NOT EXISTS `upagraha` (
  `id` tinyint NOT NULL DEFAULT '0',
  `fid` tinyint NOT NULL DEFAULT '0',
  `code` varchar(4) NOT NULL DEFAULT '',
  `name` varchar(16) NOT NULL DEFAULT '',
...
-- Дамп данных таблицы jyotisa.upagraha: ~12 rows (приблизительно)
/*!40000 ALTER TABLE `upagraha` DISABLE KEYS */;
REPLACE INTO `upagraha` (`id`, `fid`, `code`, `name`) VALUES
	(0, 0, 'NIL', 'NIL'),
	(1, 1, 'UG1', 'DHUMA'),
	(2, 2, 'UG2', 'VYATIPAATA'),
	(3, 3, 'UG3', 'PARIVESHA'),
	...
	(10, 10, 'UG10', 'GULIKA'),
	(11, 11, 'UG11', 'MAANDI');
/*!40000 ALTER TABLE `upagraha` ENABLE KEYS */;

-- Дамп структуры для таблица jyotisa.vaara
DROP TABLE IF EXISTS `vaara`;
CREATE TABLE IF NOT EXISTS `vaara` (
  `id` tinyint NOT NULL DEFAULT '0',
  `fid` tinyint NOT NULL DEFAULT '0',
  `code` varchar(4) NOT NULL DEFAULT '',
  `name` varchar(16) NOT NULL DEFAULT '',
...
-- Дамп данных таблицы jyotisa.vaara: ~8 rows (приблизительно)
/*!40000 ALTER TABLE `vaara` DISABLE KEYS */;
REPLACE INTO `vaara` (`id`, `fid`, `code`, `name`) VALUES
	(0, 0, 'NIL', 'NIL'),
...
/*!40000 ALTER TABLE `vaara` ENABLE KEYS */;

-- Дамп структуры для таблица jyotisa.varga
DROP TABLE IF EXISTS `varga`;
CREATE TABLE IF NOT EXISTS `varga` (
  `id` tinyint NOT NULL DEFAULT '0',
  `fid` smallint NOT NULL DEFAULT '0',
  `code` varchar(4) NOT NULL DEFAULT '',
  `name` varchar(24) NOT NULL DEFAULT '',
...
-- Дамп данных таблицы jyotisa.varga: ~24 rows (приблизительно)
/*!40000 ALTER TABLE `varga` DISABLE KEYS */;
REPLACE INTO `varga` (`id`, `fid`, `code`, `name`) VALUES
	(0, 0, 'NIL', 'NIL'),
	(1, 1, 'D1', 'RASI'),
	(2, 2, 'D2', 'HORA'),
	(3, 3, 'D3', 'DREKKANA'),
...
/*!40000 ALTER TABLE `varga` ENABLE KEYS */;

-- Дамп структуры для таблица jyotisa.vim_dasa
DROP TABLE IF EXISTS `vim_dasa`;
CREATE TABLE IF NOT EXISTS `vim_dasa` (
  `id` tinyint NOT NULL DEFAULT '0',
  `fid` tinyint NOT NULL DEFAULT '0',
  `code` varchar(4) NOT NULL DEFAULT '',
  `name` varchar(16) NOT NULL DEFAULT '',
...
-- Дамп данных таблицы jyotisa.vim_dasa: ~10 rows (приблизительно)
/*!40000 ALTER TABLE `vim_dasa` DISABLE KEYS */;
REPLACE INTO `vim_dasa` (`id`, `fid`, `code`, `name`) VALUES
	(0, 0, 'NIL', 'NIL'),
	(1, 1, 'SYVD', 'SURYA_DASA'),
...
/*!40000 ALTER TABLE `vim_dasa` ENABLE KEYS */;

-- Дамп структуры для таблица jyotisa._dbinfo
...
-- Дамп данных таблицы jyotisa._dbinfo: ~2 rows (приблизительно)
/*!40000 ALTER TABLE `_dbinfo` DISABLE KEYS */;
REPLACE INTO `_dbinfo` (`id`, `updated`, `version`, `revision`, `name`) VALUES
	(1, 20190711124500, 19, 0, 'Jyotisa DB v19'),
	(2, 20211211124500, 21, 0, 'Jyotisa DB v21');
/*!40000 ALTER TABLE `_dbinfo` ENABLE KEYS */;
